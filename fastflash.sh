...
images=(u-boot-spl-16k-sign.bin sml-sign.bin tos-sign.bin u-boot-sign.bin boot-sign.img recovery-sign.img system.img cache.img userdata.img prodnv.img vendor.img)
